...
use FIANET\SceauBundle\Entity\CommandeCSVColonne;
use ReflectionClass;
...
class ImportCSVTest extends KernelTestCase
{
    ...
    public function __construct()
    {
        ...
        $this->importCsv = $this->container->get('fianet_sceau.import_csv');

        $site = $this->getMock('FIANET\SceauBundle\Entity\Site');
        $questionnairePerso = $this->getMock('FIANET\SceauBundle\Entity\QuestionnairePersonnalisation');
        $commandeCSVParametrage = $this->getMock('FIANET\SceauBundle\Entity\CommandeCSVParametrage');
