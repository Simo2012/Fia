 ...
 *
 * @ORM\Table(name="Site")
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\SiteRepository")
 */
class Site
{
    /**
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="FIANET\SceauBundle\Entity\QuestionnairePersonnalisation")
     ...
     * @var Package
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Package")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\SiteOption", mappedBy="site")
     **/
    private $siteOptions;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Site", mappedBy="sitePrincipal")
     */
    private $siteMiroirs;
     ...
     * @var Site
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Site", inversedBy="siteMiroirs")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\SousSite", mappedBy="site")
     */
    private $sousSites;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Flux", mappedBy="site")
     */
    private $flux;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Commande", mappedBy="site")
     */
    private $commandes;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Questionnaire", mappedBy="site")
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\SiteCategorie", mappedBy="site")
     */
     ...
     * @var Societe
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Societe", inversedBy="sites")
     ...
     * @var SiteType
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\SiteType")
     ...
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\AdministrationType")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Relance", mappedBy="site")
     */
    private $relances;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\ProduitQuestionnaire", mappedBy="site")
     */
