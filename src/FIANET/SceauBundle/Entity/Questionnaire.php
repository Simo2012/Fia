 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\QuestionnaireRepository")
 */
class Questionnaire
{
    /**
     ...
     * @var Site
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Site", inversedBy="questionnaires")
     ...
     * @var SousSite
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\SousSite", inversedBy="questionnaires")
     ...
     * @var Membre
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Membre", inversedBy="questionnaires")
