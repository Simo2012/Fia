 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\PackageRepository")
 */
class Package
{
    /**
     ...
     * @var PackageOption
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\PackageOption", mappedBy="package")
     */
