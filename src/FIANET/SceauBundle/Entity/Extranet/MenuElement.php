 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\Extranet\MenuElementRepository")
 */
class MenuElement
{
    /**
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Extranet\MenuElement", mappedBy="menuElementParent")
     */
     ...
     * @var MenuElement
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Extranet\MenuElement", inversedBy="menuElementsFils")
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="FIANET\SceauBundle\Entity\QuestionnaireType")
     ...
     * @var Option
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Option")
