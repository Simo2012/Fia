 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\ProduitRepository")
 */
class Produit
{
    /**
     ...
     * @var Categorie
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Categorie")
     ...
     * Set categorie
     *
     * @param \FIANET\SceauBundle\Entity\Categorie $categorie
     * @return Produit
     */
    public function setCategorie(\FIANET\SceauBundle\Entity\Categorie $categorie)
    {
     ...
     * Get categorie
     *
     * @return \FIANET\SceauBundle\Entity\Categorie
     */
