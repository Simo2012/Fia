 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\CategorieRepository")
 */
class Categorie
{
    /**
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\SiteCategorie", mappedBy="categorie")
     */
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Categorie", mappedBy="categoriePrimaire")
     */
     ...
     * @var Categorie
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Categorie", inversedBy="categoriesSecondaires")
