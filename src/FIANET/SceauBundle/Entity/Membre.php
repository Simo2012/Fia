 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\MembreRepository")
 */
class Membre
{
    /**
     ...
     * @var MembreStatut
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\MembreStatut")
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="FIANET\SceauBundle\Entity\Email")
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="FIANET\SceauBundle\Entity\Abonnement")
     ...
     * @var Avatar
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Avatar")
     ...
     * @var Civilite
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Civilite")
     ...
     * @var Coordonnee
     *
     * @ORM\OneToOne(targetEntity="FIANET\SceauBundle\Entity\Coordonnee")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="FIANET\SceauBundle\Entity\Questionnaire", mappedBy="membre")
     */
