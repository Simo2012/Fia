 ...
 * @ORM\Entity(repositoryClass="FIANET\SceauBundle\Entity\ProduitQuestionnaireRepository")
 */
class ProduitQuestionnaire
{
     ...
     *
     * @ORM\OneToOne(targetEntity="FIANET\SceauBundle\Entity\ProduitQuestionnaireReponse")
     ...
     * @var Site
     *
     * @ORM\ManyToOne(targetEntity="FIANET\SceauBundle\Entity\Site", inversedBy="produitQuestionnaires")
