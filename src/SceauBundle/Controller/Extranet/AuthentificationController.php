...
use SceauBundle\Form\Type\SiteIdType;
...
class AuthentificationController extends Controller
{
    ...
    public function loginAction()
    {
        ...
        return $this->render(
            'SceauBundle:Extranet:login_form.html.twig',
    ...
    public function motDePasseOublieAction(Request $request)
    {
        ...
        return $this->render('SceauBundle:Extranet:login_mdp_oublie.html.twig', array(
    ...
    {
        return $this->render('SceauBundle:Extranet:login_mdp_oublie_conf.html.twig');
    }
}
