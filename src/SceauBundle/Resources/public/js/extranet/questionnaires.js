...
function selectTriQuestionnaires(numTri) {
    $('#sceaubundle_questionnaires_liste_tri').val(numTri);
    $('form').submit();
}

function selectIndicateur(numIndicateur, imageIndicateur) {
    var checkbox = document.getElementById('sceaubundle_questionnaires_liste_indicateurs_' + numIndicateur);
...
function decocherRetenir() {
    document.getElementById('sceaubundle_questionnaires_liste_retenir').checked = false;
}