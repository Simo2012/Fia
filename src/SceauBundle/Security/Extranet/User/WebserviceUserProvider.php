...
namespace SceauBundle\Security\Extranet\User;

use Doctrine\ORM\EntityManager;
use SceauBundle\Entity\Extranet\Utilisateur;
...
class WebserviceUserProvider implements UserProviderInterface
{
    ...
    public function loadUserByUsername($login)
    {
        ...
        if ($utilisateurOK) {
            ...
            $societe = $this->em->getRepository('SceauBundle:Societe')
    ...
    {
        return $class === 'SceauBundle\Entity\Extranet\Utilisateur';
    }
}