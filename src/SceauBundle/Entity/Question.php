 ...
 * @ORM\Entity(repositoryClass="SceauBundle\Entity\Repository\QuestionRepository")
 * @Gedmo\TranslationEntity(class="SceauBundle\Entity\Traduction\QuestionTraduction")
 */
class Question implements Translatable
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="SceauBundle\Entity\QuestionnaireType", inversedBy="questions")
     ...
     * @var QuestionType
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\QuestionType")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\Question", mappedBy="questionPrimaire")
     */
     ...
     * @var Question
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Question", inversedBy="questionsSecondaires")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\Reponse", mappedBy="question", cascade={"persist"})
     */
    private $reponses;
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="SceauBundle\Entity\LivraisonType")
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="SceauBundle\Entity\NotationLibelle")
     ...
     * @var QuestionStatut
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\QuestionStatut")
     * @ORM\JoinColumn(name="questionStatut_id", referencedColumnName="id", nullable=false)
     */
    private $questionStatut;

    /**
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Site", inversedBy="questions")
