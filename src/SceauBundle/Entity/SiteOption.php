 ...
 * @ORM\Entity(repositoryClass="SceauBundle\Entity\Repository\SiteOptionRepository")
 */
class SiteOption
{
    /**
     ...
     * @var Option
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Option", inversedBy="siteOptions")
     ...
     * @var Site
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Site", inversedBy="siteOptions")
