...
class DroitDeReponse implements GroupSequenceProviderInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\QuestionnaireReponse", inversedBy="droitDeReponses")
     ...
     * @return DroitDeReponse
     */
    public function setQuestionnaireReponse(QuestionnaireReponse $questionnaireReponse)
    {
