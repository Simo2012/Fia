...
class SousSite
{
     ...
     * @var Site
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Site", inversedBy="sousSites")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\Commande", mappedBy="sousSite")
     */
    private $commandes;
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\Questionnaire", mappedBy="sousSite")
     */
