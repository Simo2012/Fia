 ...
 * @ORM\Entity(repositoryClass="SceauBundle\Entity\CommandeRepository")
 */
class Commande
{
    /**
     ...
     * @var Site
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Site", inversedBy="commandes")
     ...
     * @var SousSite
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\SousSite", inversedBy="commandes")
     ...
     * @var Flux
     *
     * @ORM\OneToOne(targetEntity="SceauBundle\Entity\Flux")
