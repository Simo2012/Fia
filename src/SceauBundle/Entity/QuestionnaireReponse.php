 ...
 * @ORM\Entity(repositoryClass="SceauBundle\Entity\Repository\QuestionnaireReponseRepository")
 */
class QuestionnaireReponse
{
     ...
     * @var Reponse
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Reponse", inversedBy="questionnaireReponses")
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToOne(targetEntity="SceauBundle\Entity\Questionnaire", inversedBy="questionnaireReponses")
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\DroitDeReponse", mappedBy="questionnaireReponse")
     */
