...
use SceauBundle\Entity\PackageOption;
 ...
 * @ORM\Entity(repositoryClass="SceauBundle\Entity\Extranet\OptionRepository")
 */
class Option
{
    /**
     ...
     * @var PackageOption
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\PackageOption", mappedBy="option")
     */
     ...
     * @var SiteOption
     *
     * @ORM\OneToMany(targetEntity="SceauBundle\Entity\SiteOption", mappedBy="option")
     */
    private $siteOptions;
